    ...
    <main>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          {featured.map((post) => (
            <article key={post.slug} className="paper-card overflow-hidden flex flex-col">
...
function WanderCard({ to, title, note, icon }: { to: "/journal" | "/astrology" | "/gallery" | "/about"; title: string; note: string; icon: React.ReactNode }) {
  return (
